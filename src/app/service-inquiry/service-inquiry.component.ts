...
export class ServiceInquiryComponent implements OnInit {
  ...
  async selectForm() {
    if (this.tripServices.length < 3 && this.tripServices.length > 0) {
    ...
    if (this.checkBoxValue.length > 1) {
      ...
      console.log("this ==>", this.checkBoxValue, this.generalServices);
  ...
  selectOtherServices(data) {
    ...
    console.log("generalServices", this.otherServices);
  }
